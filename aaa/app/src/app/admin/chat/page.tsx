  ...
  const sendLocation = () => {
    ...
    locationWatchId.current = navigator.geolocation.watchPosition(
      async (position) => {
        ...
        let address = '';
        if (isMapLoaded && typeof window !== 'undefined' && (window as any).AMap) {
          try {
  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div>
          <h1 style={{ fontSize: '1.25rem', fontWeight: 'bold', margin: '0 0 0.25rem 0', letterSpacing: '0.5px' }}>联系司机</h1>
          <p style={{ fontSize: '0.75rem', opacity: '0.9', margin: 0 }}>行程号: {currentTripId}</p>
        </div>
        {isConnected && (
          <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center' }}>
            <span style={{ 
              ...
              borderRadius: '9999px', 
              marginRight: '0.5rem',
              boxShadow: '0 0 3px 1px rgba(74, 222, 128, 0.5)',
              animation: 'pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite'
            }}></span>
            <span style={{ fontSize: '0.75rem', fontWeight: '500' }}>已连接</span>
          </div>
        )}
      </div>
        ...
        {messages.length === 0 && (
          <div style={{ 
            ...
            <div style={{
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ width: '3rem', height: '3rem', color: '#f97316', marginBottom: '0.5rem' }}>
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
              </svg>
            </div>
            <p style={{ color: '#6b7280', fontWeight: '500', textAlign: 'center' }}>还没有消息<br/>发送一条开始聊天吧</p>
          </div>
        )}
        {messages.map((message) => (
          <div 
            ...
            style={{ 
              ...
              marginBottom: '1rem',
              animation: message.sender === 'customer' ? 'slideIn 0.3s ease-out' : 'fadeIn 0.3s ease-out'
            }}
          >
            ...
            <div 
              style={{ 
                ...
                backgroundColor: message.sender === 'customer' ? 'linear-gradient(135deg, #f97316 0%, #fb923c 100%)' : 'white',
                ...
                borderBottomRightRadius: message.sender === 'customer' ? '0.25rem' : '1rem',
                borderBottomLeftRadius: message.sender === 'customer' ? '1rem' : '0.25rem',
                background: message.sender === 'customer' ? 
                  'linear-gradient(135deg, #f97316 0%, #fb923c 100%)' : 'white',
                border: message.sender === 'customer' ? 'none' : '1px solid rgba(0,0,0,0.05)'
              }}
            >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          ...
          <button
            ...
            style={{ 
              ...
              height: '3rem',
              border: 'none',
              boxShadow: !isConnected || newMessage.trim() === '' ? 
          ...
          <button
            ...
            style={{ 
              padding: '0.75rem', 
              borderRadius: '50%', 
              background: showMoreActions ? '#f1f5f9' : 'white',
              color: '#6b7280', 
              width: '3rem', 
              height: '3rem', 
              display: 'flex', 
