...
export interface ButtonProps extends BaseTypeProps, Omit<React.HTMLAttributes<HTMLButtonElement>, 'style'> {
    /**
     * 指定渲染的dom标签
     * @default 'button'
     */
...
export declare type ButtonGroupProps = BaseTypeProps & Pick<ButtonProps, 'size' | 'type' | 'square' | 'tag' | 'block' | 'round' | 'plain' | 'shadow' | 'disabled' | 'nativeType' | 'iconPosition'> & {
    /**
     * 点击事件
     */
