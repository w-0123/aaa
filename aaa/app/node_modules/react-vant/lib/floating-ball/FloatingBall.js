...
const FloatingBall = (0, _react().forwardRef)((p, ref) => {
  var _a, _b, _c, _d;
  ...
  }, [(_c = props.menu) === null || _c === void 0 ? void 0 : _c.items]);
  // 处理菜单
  ...
  }, [position, (_d = props.menu) === null || _d === void 0 ? void 0 : _d.direction, validMenus]);
  // 更新 menu 的位置
...
var _default = exports.default = FloatingBall;