...
const DropdownMenuItem = (0, _react().forwardRef)((_a, ref) => {
  var _b;
  var {
      options = [],
      placeholder = '请选择'
    } = _a,
    props = (0, _tslib().__rest)(_a, ["options", "placeholder"]);
  const [state, setState] = (0, _hooks.useSetState)({
    transition: true,
    showWrapper: false
  });
  const parent = (0, _react().useContext)(_DropdownMenuContext.default);
  const currentValue = (_b = parent.value) === null || _b === void 0 ? void 0 : _b[props.name];
  const onClosed = () => {
    var _a, _b;
    setState({
      showWrapper: false
  ...
  const renderOption = option => {
    ...
    return (0, _jsxRuntime().jsx)(_cell.default, Object.assign({
      ...
      children: active && (activeIcon || (0, _jsxRuntime().jsx)(_icons().Success, {
  ...
  const renderContent = () => {
    ...
    return (0, _jsxRuntime().jsx)("div", Object.assign({
      ...
      children: (0, _jsxRuntime().jsxs)(_popup.default, Object.assign({}, attrs, {
        ...
        children: [options === null || options === void 0 ? void 0 : options.map(renderOption), props.children]
      }))
    }));
  };
