...
const Field = (0, _react().forwardRef)((p, ref) => {
  var _a;
  ...
  const renderInput = () => {
    ...
    if ((0, _utils.isDef)(props.children)) {
...
const FIELD_KEY = exports.FIELD_KEY = Symbol('field');
const FieldNamespace = Object.assign(Field, {
  [_constant.COMPONENT_TYPE_KEY]: FIELD_KEY
});
var _default = exports.default = FieldNamespace;