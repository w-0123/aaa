...
const popupProps = ['overlay', 'duration', 'overlayStyle', 'overlayClass', 'closeOnClickOverlay', 'teleport', 'onClosed', 'onOpened', 'onClickOverlay'];
...
const Popover = (0, _react().forwardRef)((_a, ref) => {
  ...
  const [visible, updateShow] = (0, _hooks.usePropsValue)({
    value: props.visible,
    defaultValue: false,
