...
exports.getSkuComb = exports.getSelectedSkuValues = exports.getSelectedProperties = exports.getSelectedPropValues = exports.default = void 0;
exports.getSkuImgValue = getSkuImgValue;
exports.normalizeSkuTree = exports.normalizePropList = exports.isSkuChoosable = exports.isAllSelected = void 0;
...
const isAllSelected = (skuTree, selectedSku) => {
  ...
  const selected = Object.keys(selectedSku).filter(skuKeyStr => selectedSku[skuKeyStr] !== _constants.UNSELECTED_SKU_VALUE_ID);
...
const isSkuChoosable = (skuList, selectedSku, skuToChoose) => {
  ...
  const skusToCheck = Object.keys(matchedSku).filter(skuKey => matchedSku[skuKey] !== _constants.UNSELECTED_SKU_VALUE_ID);
