...
const defaultMinDate = (0, _utils2.getToday)();
...
const Calendar = (0, _react().forwardRef)((_a, ref) => {
  ...
  const renderMonth = (date, index) => {
    const showMonthTitle = !props.horizontal && (index !== 0 || !props.showSubtitle);
  ...
  const renderCalendar = () => (0, _jsxRuntime().jsxs)("div", Object.assign({
    ...
    }), props.horizontal ? (0, _jsxRuntime().jsx)("div", Object.assign({
      ref: bodyRef,
      className: (0, _clsx().default)(bem('horizontal-body'))
    }, {
      children: (0, _jsxRuntime().jsx)(_swiper.default, Object.assign({
        indicator: () => null,
        onChange: index => {
          updateState({
            subtitle: monthRefs[index].getTitle()
          });
        }
      }, {
        children: months.map((month, index) => (0, _jsxRuntime().jsx)(_swiper.default.Item, {
          children: renderMonth(month, index)
        }, month))
      }))
