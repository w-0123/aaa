...
const CollapseIcon = ({
  ...
  className: (0, _clsx().default)(bem('collapse-icon')),
  viewBox: '0 0 30 24'
}, {
...
const DeleteIcon = ({
  ...
  className: (0, _clsx().default)(bem('delete-icon')),
  viewBox: '0 0 32 22'
}, {
  children: (0, _jsxRuntime().jsx)("path", {
...
const [bem] = (0, _utils.createNamespace)('key');
const NumberKeyboardKey = _a => {
  var {
      children,
      className,
      style
  ...
  const onTouchEnd = event => {
    ...
    if (active) {
      ...
      setActive(false);
      (_a = props.onPress) === null || _a === void 0 ? void 0 : _a.call(props, props.text, props.type);
    }
  };
  const renderContent = () => {
    if (props.loading) {
    ...
    switch (props.type) {
      case 'delete':
        return text || (0, _jsxRuntime().jsx)(DeleteIcon, {
          bem: bem
        });
      case 'extra':
        return text || (0, _jsxRuntime().jsx)(CollapseIcon, {
          bem: bem
        });
      default:
        return text;
  ...
  return (0, _jsxRuntime().jsx)("div", Object.assign({
    ...
    children: (0, _jsxRuntime().jsx)("div", Object.assign({
      role: 'button',
      tabIndex: 0,
      className: (0, _clsx().default)(bem([props.color, {
        large: props.large,
        active,
...
var _default = exports.default = NumberKeyboardKey;