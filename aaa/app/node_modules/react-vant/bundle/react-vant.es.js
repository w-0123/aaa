...
const Slide = (props) => {
  ...
  }, props.lazyload ? /* @__PURE__ */ React.createElement(Lazyload, {
    placeholder: renderPlaceholder()
...
const PickerColumn = memo(forwardRef((props, ref) => {
  ...
  const setIndex = (index2) => {
    ...
    const offset = -index2 * itemHeight;
    const trigger = () => {
      var _a;
  ...
  const getIndexByOffset = (offset) => range(Math.round(-offset / itemHeight), 0, options.length - 1);
