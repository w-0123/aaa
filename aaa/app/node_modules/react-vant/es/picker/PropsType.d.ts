...
/** 列选项 */
export declare type PickerColumnOption = {
...
/** 列 */
export declare type PickerColumn<T = PickerColumnOption> = (string | T)[];
export declare type PickerFieldNames = {
    text?: string;
    value?: string;
    children?: string;
};
export declare type PickerPopupActions = {
    open: () => void;
    close: () => void;
    toggle: () => void;
};
...
export declare type PickerProps<T = PickerColumnOption> = PickerSingleProps<T> | PickerMultipleProps<T>;
export interface PickerColumnProps extends BaseTypeProps {
    ...
    onSelect: (value: PickerColumnOption, index: number, ignoreChange?: boolean) => void;
}
