...
const Calendar = forwardRef((_a, ref) => {
  ...
  const renderCalendar = () => _jsxs("div", Object.assign({
    ...
    }), props.horizontal ? _jsx("div", Object.assign({
      ref: bodyRef,
      className: cls(bem('horizontal-body'))
    }, {
      children: _jsx(Swiper, Object.assign({
        indicator: () => null,
        onChange: index => {
          updateState({
        ...
        children: months.map((month, index) => _jsx(Swiper.Item, {
